...
//responsible for the different fish in the game, their
//collision management and more - inherit from the EnemyFish class.

class LFish :public EnemyFish
{
public:
	LFish(sf::Texture& texture, sf::Vector2f location, double_t size);
